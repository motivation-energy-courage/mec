<template>
  <div class="submits">
    <h1 style="text-align: center">あなたのSustainable Tipsを教えてください</h1>
    <div class="newpost">
      <h1 style="text-align: center">New Post</h1>
    </div>
    <div class="normal-box2"></div>
    <div id="submit"><h1>投稿内容</h1></div>
    <div id="submit-title"><h1>タイトル</h1></div>
    <div class="textbox">
      <input
        class="textbox1"
        v-on:click="Post"
    ...
    <div id="up">
      ...
      <div class="divid">
        <hr style="text-align: center" width="1400" size="20" noshade="" />
        <br />
        ...
        <img
          ...
          class="onepiece"
        />
        <img src="@/assets/cosme.jpg" width="400" height="300" class="cosme" />
        <img
          src="@/assets/ピアス.jpg"
          width="400"
          height="300"
