...
export default {
 ...
 "GUの環境評価はSo GUの労働評価はBADです。GUは労働に関する国際基準の行動規範を公開していますが、工場で働く人に生活賃金を支払っているかは不透明な状態です。日本を本拠とする国際人権NGO「ヒューマンライツ・ナウ」が、アパレル業界の労働環境に関する実態調査を行った結果、ユニクロやユニクロと同じFR社の完全子会社であるGUの下請け工場における労働問題が非常に深刻だという声が聞かれたそうです。これらから、GUはウイグル族の人権問題などに関与している可能性があると言えます。 BCIコットンを使用しているので、よりオーガニックなコットンの使用率を上げる必要性もあると言及できます。",
      ...
      textss: [
        ...
        "UNIQLOの労働評価はBADです。2021年4月にウイグル人に対する強制労働と人道に対する罪を隠匿した疑いで人権団体から告訴されたほか、元従業員からの聞き取りや潜入調査などによって5年で8割を超える離職率の高さや下請け工場の労働環境の劣悪さや健康および安全への危惧が報告されています。UNIQLOを展開するファーストリテイリングは問題点について認めた上で国内店舗の従業員を対象に正社員化する方針を発表していますが、国内に限られており国外の下請け工場などの労働環境の改善の具体的な改善策の記述は多くはありません。",
        ...
        "adidasの労働評価はSo Soです。adidasはサプライチェーンの管理を徹底しており、サプライヤーの能力向上と監査が繰り返し行い、さらに外部の第三者機関によって十分な評価・教育プログラムが組まれています。監査によって判明した怠慢や問題は明確に改善指示が出され、改善されない場合は処罰などの対処がなされます。この評価制度・管理制度によって評価リスクと販売リスクのカットに繋げ品質と基準の向上に努めています。",
          "PeopleTreeの労働評価はGREATです。Peopletreでは商品を作る職人や生産者に対して、カタログなどを利用した商品を知る機会や技術研修の機会を設けています。この機会は生産を担う団体同士の交流やコミュニティプロジェクトの推進や全体的に統一したスキルアップの効果をもたらしています。また、生産団体への発注時に必要に応じて歯中学の50％を前払いすることで、農家や団体の大小などに関わらずフェアトレードが行えるように資金繰りができる仕組みが整えられています。またフェアトレードで得た利益はコミュニティに還元され、貧しい家庭の子どもたちへの教育の機会の提供や地域開発に役立てられています。",
